...
def create_message(sender, to, subject, message_text, img_file):
    ...
    file_name = base_loc + location + '_' + formatted_date_time + '.jpg'
    ...
    #file_path = os.getcwd()
    #target_folder = os.path.join(current_path , base_loc)
    #os.rename(file_path , target_folder)
    #print("File path :" , file_path)
    #print("Alert folder path :" , target_folder)
    print("Alert folder path :" , current_path)
